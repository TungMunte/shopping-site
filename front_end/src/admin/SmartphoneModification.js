...
function SmartphoneModification() {
  ...
  async function handleSubmit(event) {
    try {
      ...
      const response = await axios.put(
        `http://localhost:8080/api/smartphone/put/${id}`,
        {
          name,
          brand,
          technology,
                ...
                {completed === false && (
                  <div className="mb-md-5 mt-md-4 pb-5">
                    ...
                    <p className="text-white-50 mb-5">
                      Please enter smartphone's information
                    </p>
                    ...
                    <div className="form-outline form-white mb-4">
                      <img
                        src={`http://localhost:8080/api/smartphone/image/get/${imageCode}`}
                        style={{
                          width: "130px",
                          height: "130px",
                        }}
...
export default SmartphoneModification;
