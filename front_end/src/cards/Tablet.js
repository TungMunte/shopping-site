    ...
    if (authContext.isAuthenticated) {
      try {
        const response = await axios.post(
          `http://localhost:8080/api/order/add/${authContext.username}/tablet`,
          {
            quantity: quantity,
  ...
  return (
    <div className="col-6 col-md-6 col-lg-4 mb-3">
      <div className="card">
        <img
          className="card-img"
          src={`http://localhost:8080/api/tablet/image/get/${props.imageCode}`}
          alt="Vans"
        />
        <div className="card-body">
          ...
          <div className="text-success">Deliver time : 3 days</div>
